...
def save_xmas(selected_day: int, selected_part: int = None, is_test: bool = False):
    ...
    elif selected_day == 14:
        day_14(selected_part, is_test)
    elif selected_day == 15:
        day_15(selected_part, is_test)
    elif selected_day == 16:
        day_16(selected_part, is_test)
    elif selected_day == 17:
        day_17(selected_part, is_test)
    elif selected_day == 18:
        day_18(selected_part, is_test)
